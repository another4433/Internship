...
"antiquity", "antiquities", "apology", "apologies", "apologize", "apparently", "appendix", "applied"];
    ...
    if (textChecker.length > 0){
        ...
        switch(counting){
            case 0: 
                ...
                break;
            case 1: document.getElementById("suggestionBox").style.height = "70px"; break;
            case 2: document.getElementById("suggestionBox").style.height = "110px"; break;
            case 3: document.getElementById("suggestionBox").style.height = "160px"; break;
            case 4: document.getElementById("suggestionBox").style.height = "210px"; break;
            case 5: document.getElementById("suggestionBox").style.height = "250px"; break;
            default: document.getElementById("suggestionBox").style.height = "300px";
        }
    }
    else {
        boxEditor.style = "";

...
namespace Types_of_Data_Structures
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            KWLinkedList<Integer> theNums = new KWLinkedList<Integer>();
            KWArrayList<String> theTexts = new KWArrayList<String>();
            theNums.addFirst(1);
            theString.addLast("hello");
            theNums.addLast(2);
            theString.addFirst("world");
            theNums.display();
            theString.display();
        }
    }
